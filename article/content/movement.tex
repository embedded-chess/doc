...
Problematisch ist dabei, dass sich der Dezibot nicht zuverlässig geradeaus bewegt. Dies ist unter anderem aufgrund der Idee der Fortbewegungsart des Dezibots inhärent. Es werden Vibrationsmotoren verwendet, die zwei starre Hinterbeine unabhängig voneinander auf und ab bewegen~\cite{dezibotteamDezibotDezibot2025}. Dabei ist es nicht auszuschließen, dass die Motoren den Dezibot ebenso in andere Richtungen bewegen. Zudem ist die Bewegung stark abhängig von dem Untergrund und nicht deterministisch. Das Bewegen in kleineren Schritten -- also kein kontinuierliches Laufen, sondern regelmäßiges kurzes Pausieren -- brachte eine leichte Verbesserung. 
...
Insgesamt ist die Infrarot"=basierte Rotation der aktuell vielversprechenste Versuch, der zur Abgabe der Arbeit implementiert ist. Dennoch sind einige Probleme aufgetreten, die im folgenden erläutert werden.
...
In der zweiten Messstudie wurde eine Infrarot"=basierte Links"= bzw. Rechts"=Rotation vom Dezibot durchgeführt. Dabei wurde der Dezibot in die vier verschiedenen Himmelsrichtungen ausgerichtet. Insgesamt wurden jeweils fünf Versuche durchgeführt. Die Messwerte sind in \autoref{tab:measurements-ir-rotation} in \autoref{sec:measurements-ir-rotation} aufgelistet. Die daraus resultierenden durchschnittlichen Differenzen zwischen dem Ziel"= und dem tatsächlich erreichten Winkel sowie die Standardabweichungen der Messungen pro Rotationsart sind in \autoref{tab:measurements-dezibot-angle-avg-dev} dargestellt.
